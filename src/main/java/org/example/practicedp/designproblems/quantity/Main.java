package org.example.practicedp.designproblems.quantity;

import org.example.practicedp.designproblems.quantity.color.RgbColor;
import org.example.practicedp.designproblems.quantity.length.LengthQuantity;
import org.example.practicedp.designproblems.quantity.length.LengthUnit;

import static org.example.practicedp.designproblems.quantity.length.LengthUnit.*;
