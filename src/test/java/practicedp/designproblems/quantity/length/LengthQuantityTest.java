...
import static practicedp.designproblems.quantity.length.LengthUnit.CENTIMETER;
import static practicedp.designproblems.quantity.length.LengthUnit.KILOMETER;
import static practicedp.designproblems.quantity.length.LengthUnit.METER;
